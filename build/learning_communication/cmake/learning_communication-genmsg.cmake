...
message(STATUS "learning_communication: 0 messages, 1 services")
...
get_filename_component(_filename "/home/liyike/catkin_ws/src/learning_communication/srv/AddTwoInts.srv" NAME_WE)
add_custom_target(_learning_communication_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_communication" "/home/liyike/catkin_ws/src/learning_communication/srv/AddTwoInts.srv" ""
)
...
_generate_srv_cpp(learning_communication
  "/home/liyike/catkin_ws/src/learning_communication/srv/AddTwoInts.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_communication)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_communication/.+/__init__.pyc?$"
  )
endif()
